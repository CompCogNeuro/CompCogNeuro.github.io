...
$$
g_i(t) = \rm{Gi} \left[ \rm{ff}(t) + \rm{fb}(t) \right]
$$
...
$$
\rm{ff}(t) = \rm{FF} \left[ \langle g_e \rangle - \rm{FF0} \right]_+
$$
...
$$
\rm{fb}(t) = \rm{fb}(t-1) + dt \left[ \rm{FB} \langle y \rangle - \rm{fb}(t-1) \right]
$$
